...
if __name__ == "__main__":
    ...
    post("/balances/transfer", {"from_account_id": 1, "to_account_id": 1, "amount": 50.0})   # même compte
    post("/balances/transfer", {"from_account_id": 1, "to_account_id": 2, "amount": 5000.0}) # solde insuffisant
    post("/balances/transfer", {"from_account_id": 999, "to_account_id": 2, "amount": 50.0}) # compte inexistant
